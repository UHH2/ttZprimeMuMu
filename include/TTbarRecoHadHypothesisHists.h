...
protected:
    ...
    TH1F *NJet_sum_rec, *NJet_tophad1_rec, *NJet_tophad2_rec, *NWJets_sum_rec, *NWJet_tophad2_rec,*NWJet_tophad1_rec, *DeltaR_Mu1_Jets, *DeltaR_Mu2_Jets,*DeepCSV_tophad2_rec,*DeepCSV_tophad1_rec,*DeltaTop_gen_rec;
