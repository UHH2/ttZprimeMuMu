...
protected:
    ...
    TH1F *M_tophad1_rec, *M_tophad2_rec, *M_tophad1_rec_0jet, *M_tophad1_rec_1jet, *M_tophad1_rec_2jet,*M_tophad1_rec_3jet, *DeltaM_rec,*DeltaM_rec_W;//*M_ttbar_rec, *M_ttbar_gen;
    TH1F *M_tophad2_rec_0jet, *M_tophad2_rec_1jet, *M_tophad2_rec_2jet,*M_tophad2_rec_3jet;
    TH1F *Pt_tophad1_rec, *Pt_tophad2_rec, *Pt_ttbar_rec, *Pt_ttbar_gen,*Mw_tophad1_rec, *Mw_tophad2_rec;
    TH1F *NJet_sum_rec, *NJet_tophad1_rec, *NJet_tophad2_rec, *DeltaR_Mu1_Jets, *DeltaR_Mu2_Jets,*DeepCSV_tophad2_rec,*DeepCSV_tophad1_rec,*DeltaTop_gen_rec;
