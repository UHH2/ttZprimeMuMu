...
namespace uhh2examples {
  ...
  class ttZPrimeInclusiveModule: public AnalysisModule {
  public:

    explicit ttZPrimeInclusiveModule(Context & ctx);
  ...
  private:
    ...
    // unique_ptr<Selection> njet_sel, nmuon_sel, n_gen_muon_sel, nele_sel, n_gen_ele_sel, st_sel, lumi_sel, mu2_sel, trigger_sel, trigger_sel1, mttbargen_sel,nbjet_sel;
    unique_ptr<Selection> mu2_sel, trigger_sel1, trigger_sel2;
  ...
  ttZPrimeInclusiveModule::ttZPrimeInclusiveModule(Context & ctx){
    cout << "Hello from ttZPrimeInclusiveModule!" << endl;
    ...
    MuId = AndId<Muon>(MuonID(Muon::CutBasedIdTight), PtEtaCut(53.0, 2.4), MuonIso(0.15));
    ...
    //Preselection
    trigger_sel1.reset(new TriggerSelection("HLT_Mu50_v*")); //original: IsoMu24
    trigger_sel2.reset(new TriggerSelection("HLT_TkMu50_v*"));
   ...
   bool ttZPrimeInclusiveModule::process(Event & event) {
   ...
   h_nocuts->fill(event);
    ...
    return true;
     ...
     UHH2_REGISTER_ANALYSIS_MODULE(ttZPrimeInclusiveModule)
